describe('Tasklist Tests', () => {
	...
	it('Select A Task', () => {
		...
		cy.get('#add-task-btn').click();
		cy.get('#tasks-container').children().eq(0).shadow().children().eq(2).get(0).click();
		cy.get('#tasks-container').then($el => {
	...
	it('Remove A Task', () => {
		...
		cy.get('#new-task-count').clear().type('3');
		cy.get('#add-task-btn').click();
		cy.get('#tasks-container').children().eq(0).shadow().children().eq(4).click();
	...
	it('Remove Selected Task', () => {
		...
		cy.get('#add-task-btn').click();
		cy.get('#tasks-container').children().eq(0).shadow().children().eq(2).click();
		cy.get('#tasks-container').children().eq(0).shadow().children().eq(4).click();
